...
public class Constants
{
    ...
    public static readonly string BOB_LOOP = "localhost:10010"; // Loop server endpoint for Bob
    ...
    public static readonly string CAROL_LOOP = "localhost:10011"; // Loop server endpoint for Carol
