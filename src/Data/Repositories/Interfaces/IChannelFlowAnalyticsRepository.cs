...
/// <summary>
/// Windowed per-channel aggregations over ForwardingHtlcEvent. Succeeded HTLCs only — every
/// query filters Outcome == Settled, so failed and in-flight events never count as flow.
/// </summary>
public interface IChannelFlowAnalyticsRepository
{
    /// <summary>
