...
namespace FundsManager.Migrations
{
    ...
    [Migration("20230724145306_RemoveConstraintOnNodeName")]
    partial class RemoveConstraintOnNodeName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FundsManager.Data.Models.LiquidityRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FundsManager.Data.Models.WalletWithdrawalRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FundsManager.Data.Models.WalletWithdrawalRequestPSBT", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FMUTXOWalletWithdrawalRequest", b =>
                {
                    ...
                    b.HasOne("FundsManager.Data.Models.WalletWithdrawalRequest", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FundsManager.Data.Models.Node", b =>
                {
                    b.HasOne("FundsManager.Data.Models.Wallet", "ReturningFundsWallet")
                        .WithMany()
            ...
            modelBuilder.Entity("FundsManager.Data.Models.WalletWithdrawalRequestPSBT", b =>
                {
                    b.HasOne("FundsManager.Data.Models.ApplicationUser", "Signer")
                        .WithMany()
                        .HasForeignKey("SignerId");

                    b.HasOne("FundsManager.Data.Models.WalletWithdrawalRequest", "WalletWithdrawalRequest")
